...
8. Before/after canvas as review surface — SEEDED (canvas widget exists)
9. Teachable Moments as pedagogy primitive — SEEDED (Explain agent)
...
12. Cmd+K command palette — SHIPPED (wordmark opens it)
13. Two-surface confirmation — PLANNED
14. CRDT intent-object continuity — PLANNED
...
| A5. Intent Drop | asi-bridge-protocol.ts | SEEDED |
| A6. Pinned Thought | progress-protocol.ts | PLANNED |
| B1. Surface instantiation | browser app | SHIPPED (browser) |
...
| C2. Coalition dispatch | asi-bridge-service.ts | SEEDED |
| C5. Plan Mode | lesson commands | SEEDED |
| C6. Before/after canvas | — | PLANNED |
| C7. Ghost Timeline | — | PLANNED |
| C8. Drag-to-Ask | — | PLANNED |
| C9. Teachable Moments | explain-agent.ts | SEEDED |
| C10. Pedagogy library | progress-service.ts | SEEDED |
| C15. Agent queue | — | PLANNED |
| C16. Mode cycle | teacher-focus-mode.ts | SEEDED (2 modes) |
| C18. Checkpoint/rewind | — | PLANNED |
| D1. Per-hunk approval | — | PLANNED |
| H1-H7. Learning features | curriculum system | SEEDED |
